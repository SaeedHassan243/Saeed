...
proc create_root_design { parentCell } {
  ...
  set led_out_1_0 [ create_bd_port -dir O led_out_1_0 ]
  set led_out_2_0 [ create_bd_port -dir O led_out_2_0 ]
  set led_out_3_0 [ create_bd_port -dir O led_out_3_0 ]
  set led_out_4_0 [ create_bd_port -dir O led_out_4_0 ]
  set led_out_5_0 [ create_bd_port -dir O led_out_5_0 ]
  set led_out_6_0 [ create_bd_port -dir O led_out_6_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {5.000000} \
   ...
   CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR1 {40} \
   CONFIG.PCW_FCLK3_PERIPHERAL_CLKSRC {IO PLL} \
   CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR0 {20} \
   CONFIG.PCW_FCLK3_PERIPHERAL_DIVISOR1 {16} \
   ...
   CONFIG.PCW_FPGA3_PERIPHERAL_FREQMHZ {5} \
   ...
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.244} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY1 {0.228} \
   ...
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.244} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.228} \
   ...
   CONFIG.PCW_UIPARAM_DDR_DQS_0_LENGTH_MM {25.33} \
   CONFIG.PCW_UIPARAM_DDR_DQS_0_PACKAGE_LENGTH {101.239} \
   CONFIG.PCW_UIPARAM_DDR_DQS_0_PROPOGATION_DELAY {160} \
   CONFIG.PCW_UIPARAM_DDR_DQS_1_LENGTH_MM {27.07} \
   ...
   CONFIG.PCW_UIPARAM_DDR_DQ_0_LENGTH_MM {22.32} \
   CONFIG.PCW_UIPARAM_DDR_DQ_0_PACKAGE_LENGTH {104.5365} \
   CONFIG.PCW_UIPARAM_DDR_DQ_0_PROPOGATION_DELAY {160} \
   CONFIG.PCW_UIPARAM_DDR_DQ_1_LENGTH_MM {22.44} \
  ...
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_ports io0_o_0] [get_bd_pins axi_quad_spi_0/io0_o] [get_bd_pins ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_quad_spi_0_io0_o]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_ports sck_o_0] [get_bd_pins axi_quad_spi_0/sck_o] [get_bd_pins ila_0/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_quad_spi_0_sck_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports ss_o_0] [get_bd_pins axi_quad_spi_0/ss_o] [get_bd_pins ila_0/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_quad_spi_0_ss_o]
  connect_bd_net -net io1_i_0_1 [get_bd_ports io1_i_0] [get_bd_pins axi_quad_spi_0/io1_i] [get_bd_pins ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets io1_i_0_1]
  connect_bd_net -net led_0_led_out_1 [get_bd_ports led_out_1_0] [get_bd_pins led_0/led_out_1]
  connect_bd_net -net led_0_led_out_2 [get_bd_ports led_out_2_0] [get_bd_pins led_0/led_out_2]
  connect_bd_net -net led_0_led_out_3 [get_bd_ports led_out_3_0] [get_bd_pins led_0/led_out_3]
  connect_bd_net -net led_0_led_out_4 [get_bd_ports led_out_4_0] [get_bd_pins led_0/led_out_4]
  connect_bd_net -net led_0_led_out_5 [get_bd_ports led_out_5_0] [get_bd_pins led_0/led_out_5]
  connect_bd_net -net led_0_led_out_6 [get_bd_ports led_out_6_0] [get_bd_pins led_0/led_out_6]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins led_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
