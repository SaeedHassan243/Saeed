...
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_2 -period "1000" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 30
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_3 -period "200" [get_pins "PS7_i/FCLKCLK[3]"]
set_input_jitter clk_fpga_3 6
#The clocks are asynchronous, user should constrain them appropriately.#
